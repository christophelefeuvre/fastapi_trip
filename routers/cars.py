...
from schemas import CarInput, Trip, TripInput, CarOutput, Car, User
...
def update_car(id: int, new_data: CarInput, session: Session = Depends(get_session)) -> Car:
    car = session.get(Car, id)
    if car:
